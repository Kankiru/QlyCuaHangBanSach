...
public class QlySach_1 {
    ...
    public QlySach_1(String maSach, String maNxb, String theLoai, String maTg, String tenSach, String namXuatBan, int soLuong, int giaMua, String anh) {
        this.maSach = maSach;
        this.maNxb = maNxb;
