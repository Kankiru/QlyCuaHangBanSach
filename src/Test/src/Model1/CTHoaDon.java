...
public class CTHoaDon {
    ...
    public CTHoaDon(String maHd, String maSach, String tenSach, String soLuong, int giaMua, int giamGia, int thanhTien) {
        this.maHd = maHd;
        this.maSach = maSach;
    ...
    public CTHoaDon(String maHd, String soLuong, int thanhTien) {
        this.maHd = maHd;
        this.soLuong = soLuong;
        this.thanhTien = thanhTien;
    }
