...
import Service1.KhachHangService;
 ...
 * @author admin
 */
public class FrommKhachHang extends javax.swing.JPanel {
 private KhachHangService KHSV = new KhachHangService();
    private DefaultTableModel model;
    private int index = -1;
    /**
     * Creates new form FrommKhachHang
     */
    public FrommKhachHang() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "TÌM KIẾM", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18), new java.awt.Color(204, 0, 51))); // NOI18N
    ...
    private void btExxcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExxcelActionPerformed
        try {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                ...
                ExcelExporter.exportToExcel(tblTTKH);
                return;
            } else {
