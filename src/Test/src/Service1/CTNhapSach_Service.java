 ...
 * @author admin
 */
public class CTNhapSach_Service {
     private Connection con = null;
    private PreparedStatement ps = null;
    private ResultSet rs = null;
    private String sql = null;
    public List<CTNhapSach> getAll2(){
        List<CTNhapSach> listNs2 = new ArrayList<>();
        ...
        try {
            ...
            rs = ps.executeQuery();
            while(rs.next()){
                CTNhapSach ns = new CTNhapSach(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getInt(5), rs.getInt(6));
                listNs2.add(ns);
            }
            return listNs2;
        } catch (Exception e) {
    ...
    public int add2(CTNhapSach ns2){
        sql = "insert into CTPHIEUNHAP (MACTPN,MAPN,MASACH,DONGIA,SOLUONG,THANHTIEN) values (?,?,?,?,?,?)";
        try {
            con = DBConnect.getConnection();
            ps = con.prepareStatement(sql);
      ...
      public int upDate2(String ma,CTNhapSach ns2){
