...
public class JDKH extends javax.swing.JDialog {
 ...
 /* Create and display the dialog */
     ...
     * *********************************ĐỌC DSKH*****************************************
     */
    public void outModel(DefaultTableModel model, List<KhachHangDTO> dskh) {
        Vector row;
        model.setRowCount(0);
...
//tìm***********************************************************************
    ...
    public void Tim() {
        ...
        List<KhachHangDTO> DSKH = new ArrayList<>();
        List<KhachHangDTO> kh1 = new ArrayList<>();
        DSKH = kh.selectAll();
        if ((a.equals("Mã KH")) && txTim.getText().isEmpty()) {
            outModel(model, DSKH);
        } else if (a.equals("Mã KH")) {
            kh1.add(kh.selectById(txTim.getText().toString()));
            outModel(model, kh1);
        }
    }
